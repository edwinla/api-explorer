  ...
  return (
    <div className="App">
      ...
      <p className="App-intro">
        This API Explorer performs requests on an online RESTful API server powered by <a className="App-link" href="https://github.com/typicode/json-server" target="_blank">json-server</a>.
      </p>
